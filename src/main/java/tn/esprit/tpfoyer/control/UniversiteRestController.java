...
public class UniversiteRestController {
    ...
    // http://localhost:8089/tpfoyer/universite/find-by-nom/{nom}
    @GetMapping("/find-by-nom/{nom}")
    public List<Universite> findUniversitesByNom(@PathVariable("nom") String nom) {
        return universiteService.findUniversitesByNom(nom);
    }
}
